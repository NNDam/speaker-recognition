...
# from eval import evaluate, evaluate_train
...
def finetune(args, is_load = False):
    ...
    model = AudioClassifier(arch = 'resnet50', num_classes = args.total_classes)
            ...
            if i > 0 and i % args.valid_every == 0:
                ...
                if args.save is not None:
                    ...
                    if is_best:
                        ...
                        model.module.save(os.path.join(args.save, f'checkpoint_model_best.pt'))
                        best_acc = val_acc
                model.train()
